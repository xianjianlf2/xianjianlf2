...
[Join the private beta →](https://inkling.markxian.cn/?ref=github-profile)
...
| [Google Artemis](https://github.com/google/artemis) | [Honor `ANDROID_ADB_SERVER_PORT` as an ADB fallback](https://github.com/google/artemis/pull/146) |
...
| [LiteLLM](https://github.com/BerriAI/litellm) | [Hold fallback lifecycle frames](https://github.com/BerriAI/litellm/pull/38623) |
...
| [OpenSpec](https://github.com/DarkskyX15/OpenSpec) | [Address DSH review follow-ups](https://github.com/DarkskyX15/OpenSpec/pull/1) |
| [OpenMausBot](https://github.com/NuCl34R/OpenMausBot) | [Fix DSH retired Host turn fences](https://github.com/NuCl34R/OpenMausBot/pull/1) |
| [codeburn](https://github.com/MiloMMIN/codeburn) | [Guard DSH zstd support on older Node](https://github.com/MiloMMIN/codeburn/pull/1) |
...
| [fast-check](https://github.com/dubzzz/fast-check) | [Handle infinite `freq` in `option`](https://github.com/dubzzz/fast-check/pull/7177) |
...
| [parsar](https://github.com/MiniMax-AI-Dev/parsar) | [Bump Go patch version for govulncheck](https://github.com/MiniMax-AI-Dev/parsar/pull/262) |
...
| :-- | :-- |
| [mini-vue](https://github.com/xianjianlf2/mini-vue) | Reactivity, virtual DOM diffing, template compilation, lifecycle hooks |
| [mini-koa](https://github.com/xianjianlf2/mini-koa) | Middleware composition, onion model, context, router layering |
...
<!-- Invisible profile-view counter; renders as nothing. -->
